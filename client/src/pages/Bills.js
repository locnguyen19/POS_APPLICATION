        ...
        >
          <div className="bill-model p-3" ref={componentRef}>
            <div className="d-flex justify-content-between bill-header pb-2">
              <div>
                <h1>
                  <b>GOURMET MARKET FINLAND OY</b>
                </h1>
              </div>
              <div>
                <p>Välimerenkatu 5C</p>
                <p>00220 JÄTKÄSAARI</p>
                <p>0448361823</p>
              </div>
            </div>
            ...
            <div className="text-center">
                  <p>For any incidents or enquiries, please contact Customer Services at GourmetMarket.com</p>
                  <p>Telephone: 088 416 544</p>
            </div>
          </div>
